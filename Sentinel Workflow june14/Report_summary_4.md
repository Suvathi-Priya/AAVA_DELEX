...
| SCM-005 | AC1 | No testcase explicitly validates automatic triggering of renewal reminder notifications.; No testcase explicitly validates 30 days before expiry date trigger.; No testcase explicitly validates 15 days before expiry date trigger.; No testcase explicitly validates 7 days before expiry date trigger. | Not Covered |
| SCM-005 | AC2 | No testcase explicitly validates subscription name inclusion in renewal reminder notification.; No testcase explicitly validates expiry date inclusion in renewal reminder notification.; No testcase explicitly validates renewal amount inclusion in renewal reminder notification.; No testcase explicitly validates direct renewal link inclusion in renewal reminder notification. | Not Covered |
| SCM-005 | AC3 | No testcase explicitly validates upcoming renewal schedules visibility in customer portal.; No testcase explicitly validates reminder history visibility in customer portal.; No testcase explicitly validates renewal preferences visibility in customer portal. | Not Covered |
| SCM-005 | AC4 | No testcase explicitly validates customer ID capture in renewal reminder log.; No testcase explicitly validates subscription ID capture in renewal reminder log.; No testcase explicitly validates reminder date capture in renewal reminder log.; No testcase explicitly validates channel used capture in renewal reminder log. | Partially Covered |
| SCM-005 | AC5 | No testcase explicitly validates subscriptions with annual value greater than $10,000.; No testcase explicitly validates reminders sent to customer for high-value subscriptions.; No testcase explicitly validates reminders sent to assigned account manager for high-value subscriptions. | Not Covered |
...
The report indicates that remediation is required as multiple user stories have coverage gaps and all test execution logs are missing.