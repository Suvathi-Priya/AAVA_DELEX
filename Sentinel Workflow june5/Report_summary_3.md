...
|---------------|-------|-------------------|-----------------|
| ORM-001 | AC4 | No testcase explicitly validates approval timestamp capture in audit logs. | Partially Covered |
...
| SCM-002 | AC4 | No testcase explicitly validates that timestamp is captured in audit logs. | Partially Covered |
